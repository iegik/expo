...
abstract class Loader protected constructor(
  ...
  data class LoaderResult(val updateEntity: UpdateEntity?, val updateMessage: UpdateMessage?)
  ...
  interface LoaderCallback {
     ...
     * @return true if Loader should download the update described in the manifest part of the update response,
     * false if not.
     */
    fun onUpdateResponseLoaded(updateResponse: UpdateResponse): Boolean
  }
    ...
    loadRemoteUpdate(
      ...
      object : RemoteUpdateDownloadCallback {
        ...
        override fun onSuccess(updateResponse: UpdateResponse) {
          ...
          if (this@Loader.callback!!.onUpdateResponseLoaded(updateResponse)) {
            ...
            processUpdateManifest(updateResponse.manifestUpdateResponsePart!!.updateManifest)
          } else {
            updateEntity = null
            finishWithSuccess()
          }
