      ...
      override fun loadRemoteUpdate() {
        ...
        remoteLoader.start(object : Loader.LoaderCallback {
          ...
          override fun onSuccess(loaderResult: Loader.LoaderResult) {
            ...
            setRemoteLoadStatus(
              if (loaderResult.updateEntity != null || loaderResult.updateMessage is UpdateMessage.RollbackToEmbeddedUpdateMessage) ErrorRecoveryDelegate.RemoteLoadStatus.NEW_UPDATE_LOADED
          ...
          override fun onUpdateResponseLoaded(updateResponse: UpdateResponse): Boolean {
            ...
            return selectionPolicy.shouldLoadNewUpdate(updateManifest.updateEntity, launchedUpdate, updateManifest.manifestFilters)
          }
        })
      }
